  ...
  const features = [
    {
      ...
      title: "テキストチャット対応",
      description:
        "お客様がテキストで質問すると、AIが商品情報をもとに最適な回答を提供します。",
    },
    {
      icon: Mic,
      title: "音声チャット対応",
      description:
        "音声入力にも対応。話しかけるだけで商品の相談ができ、音声で回答を受け取れます。",
    },
    {
      icon: Code,
      title: "簡単導入",
      description:
        "HTMLにscriptタグを1行追加するだけ。既存サイトの変更は一切不要です。",
    },
    {
      icon: Table2,
      title: "スプレッドシート連携",
      description:
        "商品データはGoogleスプレッドシートで管理。APIからデータを取得することもできます。",
    },
    {
      icon: Package,
      title: "あらゆる商品に対応",
      description:
        "ファッション、家電、食品、雑貨など、どんな商品カテゴリーにも対応可能です。",
    },
    {
      icon: Zap,
      title: "24時間365日稼働",
      description:
        "人手不足の心配なし。深夜でも早朝でも、いつでもお客様対応が可能です。",
    },
  ];
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, index) => {
            ...
            return (
              <Card
                key={index}
                className="border-2 border-border/50 hover:border-primary/50 transition-all duration-300 hover:shadow-lg hover:shadow-primary/10 group bg-card/50 backdrop-blur-sm hover:-translate-y-1"
              >
                <CardHeader>
